...
import { UpdateUserForOptimisticUpdateMutationVariables } from '../../generated/graphql'
...
const resolvers = {
  Mutation: {
    updateUserForOptimisticUpdate: async (
      _parent: unknown,
      args: UpdateUserForOptimisticUpdateMutationVariables,
      context: Context,
    ) => {
      // 1~3초 지연
