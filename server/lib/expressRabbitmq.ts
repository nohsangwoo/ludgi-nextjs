...
declare global {
  ...
  var expressRabbitMQClient: ExpressRabbitMQClient | undefined
}

class ExpressRabbitMQClient {
...
const expressRabbitMQClient =
  global.expressRabbitMQClient || new ExpressRabbitMQClient()

// 개발 환경에서 Hot Reload 시 연결 유지
if (process.env.NODE_ENV === 'development')
  global.expressRabbitMQClient = expressRabbitMQClient

export default expressRabbitMQClient
