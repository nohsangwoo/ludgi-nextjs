...
export type UserSubscriptionSubscription = { __typename?: 'Subscription', userSubscription: { __typename?: 'User', id: string, email: string, name?: string | null, postsCount: number } };
